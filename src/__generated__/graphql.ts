...
export type FindSceneByFingerprintQuery = { __typename?: 'Query', findSceneByFingerprint: Array<{ __typename?: 'Scene', id: string, deleted: boolean, created: any, updated: any, title?: string | null, details?: string | null, images: Array<{ __typename?: 'Image', id: string, url: string, width: number, height: number }>, fingerprints: Array<{ __typename?: 'Fingerprint', hash: string, algorithm: FingerprintAlgorithm, duration: number }> }> };
